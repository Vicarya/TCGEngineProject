...
| タスク ID | タスク内容 | 担当者 | ステータス |
| :--- | :--- | :--- | :--- |
| **T-M7.8** | **カードの検索・フィルタリング機能実装**: カード名、種類、レベル等でリストを絞り込めるUIとロジックを実装する。 | | `未着手` |
| **T-M7.9** | **デッキへのカード追加・削除機能実装**: カードリストから選択したカードをデッキリストに追加、またはデッキリストから削除するUIとロジックを実装する。(50枚制限、同名カード4枚制限含む) | Gemini | `進行中` |
